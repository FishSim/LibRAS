...
model Inline
  ...
  LibRAS.Tanks.CST degas1(redeclare package Medium = Medium, V = 0.7, energyDynamics = Modelica.Fluid.Types.Dynamics.SteadyState, massDynamics = Modelica.Fluid.Types.Dynamics.FixedInitial, nPorts = 2, use_portsData = false) annotation(
...
equation
  ...
  connect(filter.port_b, aerob1.ports[1]) annotation(
    Line(points = {{6, -12}, {10, -12}, {10, -30}}, color = {0, 127, 255}));
  connect(fishTank1.ports[2], filter.port_a) annotation(
    Line(points = {{-18, 30}, {-18, -12}, {-14, -12}}, color = {0, 127, 255}));
